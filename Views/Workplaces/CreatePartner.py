from PyQt5.QtWidgets import QWidget, QGridLayout, QLineEdit, QLabel, QPushButton, QSizePolicy, QMainWindow
...
class CreatePartner(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        self.name_lab = QLabel(parent=self.widget, text="Название")
        self.name = QLineEdit(parent=self.widget, maxLength=255)

        self.fin_lab = QLabel(parent=self.widget, text="Финансы")
        self.fin = QLineEdit(parent=self.widget, maxLength=255)

        self.cont_lab = QLabel(parent=self.widget, text="Контакты")
        self.cont = QLineEdit(parent=self.widget, maxLength=255)

        self.acc_lab = QLabel(parent=self.widget, text="Доступ")
        self.acc = QLineEdit(parent=self.widget, maxLength=255)

        self.brand_lab = QLabel(parent=self.widget, text="Бренд")
        self.brand = QLineEdit(parent=self.widget, maxLength=255)

        self.per_lab = QLabel(parent=self.widget, text="% (только число)")
        self.per = QLineEdit(parent=self.widget, maxLength=255)

        self.deposit_lab = QLabel(parent=self.widget, text="Депозит (только число)")
        self.deposit = QLineEdit(parent=self.widget, maxLength=255)

        self.create = QPushButton(parent=self.widget, text="Добавить партнера")
        ...
        self.main_layout.addWidget(self.brand_lab, 4, 2, 1, 1, alignment=Qt.AlignBottom)
        self.main_layout.addWidget(self.brand, 5, 2, 1, 1)
        ...
        self.main_layout.addWidget(self.deposit_lab, 6, 2, 1, 1, alignment=Qt.AlignBottom)
        self.main_layout.addWidget(self.deposit, 7, 2, 1, 1)
