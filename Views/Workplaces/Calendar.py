from PyQt5.QtWidgets import QWidget, QTableWidget, QComboBox, QSpinBox, QGridLayout, QSizePolicy, QMainWindow
...
class CalendarSpace(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        self.months = QComboBox(parent=self.widget)
        ...
        self.years = QSpinBox(parent=self.widget)
        ...
        self.table = CalendarDBTable(self.widget)
